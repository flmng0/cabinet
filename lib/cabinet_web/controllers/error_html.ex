defmodule CabinetWeb.ErrorHTML do
  @moduledoc """
  ...
  #
  #   * lib/cabinet_web/controllers/error_html/404.html.heex
  #   * lib/cabinet_web/controllers/error_html/500.html.heex
  #
  ...
  defp error_message(%CabinetWeb.RequestError{message: message}) do
    {"Malformed Query", message}
  end

  defp error_message(%CabinetWeb.NotFoundError{message: message}) do
