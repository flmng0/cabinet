defmodule CabinetWeb.CoreComponents do
  @moduledoc """
  ...
  attr :class, :string
  attr :variant, :string, values: ~w(primary create)
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CabinetWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CabinetWeb.Gettext, "errors", msg, opts)
    end
  end
